...
export const Pagination = () => {
  ...
  const totalPages = useSubcategorieStore((state) => state.totalPages);
  const setPage = useSubcategorieStore((state) => state.setPage);
  const setLimit = useSubcategorieStore((state) => state.setLimit);
