...
export const Pagination = () => {
  ...
  const totalPages = useCategorieStore((state) => state.totalPages);
  const setPage = useCategorieStore((state) => state.setPage);
  const setLimit = useCategorieStore((state) => state.setLimit);
